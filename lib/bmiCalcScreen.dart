  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          elevation: 0.0,
          title: Text("Diet Plan",style: TextStyle(fontSize: 43,color: Colors.white,fontStyle: FontStyle.italic),),
          centerTitle: true,
        ),
body:
Padding(
                      ...
                      child: Container(
                            ...
                            child: Column(
                                ...
                                children: [
                                  ...
                                  Text("Height",style: TextStyle(color: Colors.black,fontSize: 35,fontWeight: FontWeight.w900),),
                                  SizedBox(height: 5,),
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Text("CM",style: TextStyle(color: Colors.black,fontSize: 20),),
  ...
  decoration: BoxDecoration(
    ...
    borderRadius: BorderRadius.all(Radius.circular(20))
                                      ...
                                      Expanded(
                                        child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text("Weight", style: TextStyle(color: Colors.black,fontSize: 30,fontWeight: FontWeight.w900),),
                                              SizedBox(height: 5,),
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  InkWell(
                                                    ...
                                                    child: CircleAvatar(
                                                     backgroundColor: Colors.white,
                                                      child: Icon(Icons.remove,color: Colors.lightBlueAccent[400],),
                                                  ...
                                                  InkWell(
                                                    ...
                                                    child: CircleAvatar(
                                                      backgroundColor: Colors.white,
                                                      child: Icon(Icons.add,color: Colors.lightBlueAccent[400],),
                                      ...
                                      Expanded(
                                        child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text("Age", style: TextStyle(color: Colors.black,fontSize: 30,fontWeight: FontWeight.w900),),
                                              SizedBox(height: 5,),
         ...
         onTap: (){
           setState(() {
            ...
            Navigator.push(context,
                MaterialPageRoute(builder: (context)=>resultScreen(height: 180,weight: 60,age: 20,calculate: calculate, Diet1:Diet1,Diet2:Diet2,Diet3:Diet3,Diet4:Diet4,Diet5:Diet5,Diet6:Diet6,img1: img1,img2: img2,img3: img3,img4: img4,img5: img5,img6: img6,)),
            );
              });
      ...
      Column(
        children: [
          Text("Calculate",style: TextStyle(color: Colors.white,fontSize: 45),),
        ],
      ),
